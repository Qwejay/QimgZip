...
class CompressWorker(QThread):
    ...
    def run(self):
        ...
        if self.settings.get("compress_mode") == "极致压缩 (体积优先)":
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.check_update_link = QLabel('<a href="https://github.com/QwejayHuang/QimgZip/releases">检查更新</a>')
        self.check_update_link.setStyleSheet('QLabel { color: #999999; text-decoration: underline; }')
        self.check_update_link.setToolTip("点击查看最新版本")
        self.statusBar.addPermanentWidget(self.check_update_link)

        self.check_update_link.linkActivated.connect(self.check_for_updates)

    def check_for_updates(self):
        import webbrowser
        webbrowser.open("https://github.com/QwejayHuang/QimgZip/releases")
